...
//GET ALL SECTION
      ...
      function save_subject($id,$exam_flag,$status){
       ...
       function getall_active_class(){
         $query="SELECT c.class_name,s.sec_name,cm.class_sec_id,cm.status FROM edu_class AS c,edu_sections AS s ,edu_classmaster AS cm WHERE cm.class = c.class_id AND cm.section = s.sec_id AND cm.status='Deactive' ORDER BY c.class_name";
         $result=$this->db->query($query);
         return $result->result();
       }

       function getall__active_class(){
