                               ...
                               <div class="row">
                                   <div class="col-md-6">
                                       <div class="form-group">
                                           ...
                                           <input type="password" class="form-control" name="oldpassword" id="oldpassword" placeholder="Current Password" value="" maxlength='12'><span toggle="#oldpassword" class="fa fa-fw fa-eye-slash field-icon oldpassword"></span>
                                       </div>
                                   </div>
                               ...
                               <div class="row">
                                   <div class="col-md-6">
                                       <div class="form-group">
                                           ...
                                           <input type="password" class="form-control"  name="newpassword" id="newpassword" placeholder="New Password" value="" maxlength='12'><span toggle="#newpassword" class="fa fa-fw fa-eye-slash field-icon newpassword"></span>
                                       </div>
                                   </div>
								   <div class="col-md-6"></div>
                               </div>
