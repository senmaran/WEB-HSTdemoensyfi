         ...
         <div class="content">
            <div class="row">
               <div class="col-md-12">
                 ...
                 <a href="<?php echo base_url(); ?>timetable/view_class/<?php echo base64_encode($rows->term_id*9876); ?>" class="btn btn-primary" style="width:150px;cursor: pointer;"><?php echo $rows->term_name; ?></a>
             <?php      } ?>
               </div>
               </div>
             </div>
