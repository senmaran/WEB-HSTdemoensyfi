...
<div class="content">
   <div class="col-md-12">
      <div class="card">
         <div class="header">
            <legend><h4 class="modal-title">Select Day for <?php foreach($get_name_class as $rows){} echo $rows->class_name.'-'.$rows->sec_name;  ?></h4><span><button onclick="history.go(-1);" class="btn btn-wd btn-default pull-right" style="margin-top:-40px;">BACK</button></span></legend>
         </div>
         <div class="content">
            <div class="row">
               <div class="col-md-12">
