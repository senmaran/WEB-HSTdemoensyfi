...
class Apiteacher extends CI_Controller {
	...
	$data['result']=$this->apiteachermodel->version_check($version_code);
...
//-----------------------------------------------//
	...
	public function exam_for_teacher(){
		...
		$data['result']=$this->apiteachermodel->exam_for_teacher($teacher_id);
		$response = $data['result'];
		echo json_encode($response);
	}
	...
	public function exam_details_for_teacher(){
		...
		$data['result']=$this->apiteachermodel->exam_details_for_teacher($teacher_id);
		$response = $data['result'];
		echo json_encode($response);
